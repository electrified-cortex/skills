...
| `--subject` | Yes | Short human-readable description of message intent |
...
6. Assemble JSON object with fields `from`, `to`, `sent`, `subject`, `body`:
   ```json
   {"from":"<from>","to":"<to>","sent":"<ISO 8601 UTC>","subject":"<subject>","body":"<body>"}
   ```
