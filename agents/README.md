...
(e.g. `.claude/agents/`, `.github/agents/`, or equivalent)
...
Copy the agent file into your project's agent directory
and invoke it via your runtime's subagent dispatch
mechanism with a prompt pointing to the target file.
