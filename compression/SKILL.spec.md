...
with negligible loss of comprehension in practice. We adopted this insight and extended it with
...
LLMs parse compressed text with negligible loss of understanding in practice. The spec (this file)
