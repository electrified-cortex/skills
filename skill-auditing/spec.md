...
In the wrong example, `PATH:` is embedded in a narrative sentence and is not on its own final line. The caller parses only the last line of stdout; mixed narrative breaks the parse contract.
