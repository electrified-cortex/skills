...
Step 5 — Dispatch:
Dispatch all swarm personalities in parallel using `dispatch` skill. All dispatches in single swarm invocation MUST be issued as single batch; don't issue sequentially.
