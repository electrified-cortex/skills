...
- SA003 [WARN]: "NOT" (ALL CAPS) appears 8 times in the document (lines 176ΓÇô183).
...
- SA031 [WARN] line 99: Level-3 sibling headings mix casing styles.
  Note: "Option A ΓÇö Wire status to your Monitor" leaves "status", "to", and "your" lowercase, and "Option B ΓÇö Implement the loop yourself" leaves "the", "loop", and "yourself" lowercase, while "On Startup" (line 129) uses consistent Title Case; the three headings do not follow a uniform convention.
