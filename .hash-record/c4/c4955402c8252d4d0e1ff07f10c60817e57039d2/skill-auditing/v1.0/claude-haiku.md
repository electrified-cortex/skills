---
hash: c4955402c8252d4d0e1ff07f10c60817e57039d2
file_paths:
  - gh-cli/gh-cli-prs/gh-cli-prs-merge/spec.md
  - gh-cli/gh-cli-prs/gh-cli-prs-merge/uncompressed.md
...
Skill Audit: gh-cli-prs-merge

Verdict: PASS
Type: dispatch
Path: gh-cli/gh-cli-prs/gh-cli-prs-merge
Failed phase: none
...
| Name matches folder (A-FM-1) | PASS | gh-cli-prs-merge matches folder |
...
| Check | Result | Notes |
| --- | --- | --- |
| Coverage | PASS | Merge strategies (merge/squash/rebase), delete-branch, update-branch, --force warning, revert, close without merge all covered |
...
| Completeness | PASS | Strategy prompt-interactive warning present; conflict handling for update-branch present |
| Breadcrumbs | PASS | Scope section with cross-references |
